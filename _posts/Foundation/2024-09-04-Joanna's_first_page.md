...
<div class="container">
    ...
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="menu" class="py-4 text-light">
            <p>Welcome to Snake, press  <span style="background-color: #15496A; color: #ffffff">space</span> to begin</p>
            <a id="new_game" class="link-alert">new game</a>
            <a id="setting_menu" class="link-alert">settings</a>
        </div>
        <!-- Game Over -->
        <div id="gameover" class="py-4 text-light">
            <p>Game Over, press <span style="background-color: #15496A; color: #ffffff">space</span> to try again</p>
        ...
        <div id="setting" class="py-4 text-light">
            <p>Settings Screen, press <span style="background-color: #15496A; color: #FFFFFF">space</span> to go back to playing</p>
...
<script>
    (function(){
        ...
        let setWall = function(wall_value){
            wall = wall_value;
            if(wall === 0){screen_snake.style.borderColor = "#F0CBF0";}
            if(wall === 1){screen_snake.style.borderColor = "#F0CBF0";}
        }
    })();
</script>